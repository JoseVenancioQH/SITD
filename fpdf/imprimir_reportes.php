<?php    
	...
	$pdf->nombrereporte = "Reporte Varios";
		...
		{			        
				...
				{				    
				 ...
				 // $pdf->ImagePngWithAlpha("../fotosparticipantes/".$curp.".png",0,20,11,16);
				  ...
				  $data[4]['TEXT'] = "[".$curp."]\n".strtoupper(html_entity_decode($nombre))."\n".strtoupper(html_entity_decode($appaterno))."\n".strtoupper(html_entity_decode($apmaterno))."\n[".date('d-m-Y', strtotime ($fechanac))."]";
				  $data[4]['T_SIZE'] = $fsize;
				  $data[4]['T_ALIGN'] = "L";
				  $data[4]['V_ALIGN'] = "T";
				  ...
				  foreach ($arraycategorias as $val) {			  				      
					  ...
					  foreach ($datodesglosearr as $datoarr) {	                   			  
						...
						if($dato[0]=='M'){  
						  $data[11]['TEXT'] = html_entity_decode($dato[1]);				  
						...
						if($dato[0]=='AI'){
						  $data[13]['TEXT'] = $data[13]['TEXT']." (". html_entity_decode($dato[1]);				  
						  $data[13]['T_SIZE'] = $fsize;
						  $data[13]['T_ALIGN'] = "L";
						  $data[13]['V_ALIGN'] = "T"; 
						  $data[13]['LN_SIZE'] = $separacion_linea;				   
