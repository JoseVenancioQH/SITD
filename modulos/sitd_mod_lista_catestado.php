...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_lista_catestado.js"></script>
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('addall','Editar Grupo Estado')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('edit','Editar Estado')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('add','Nueva Estado');" class="toolbar">
                        ...
                        <div class="header icon-48-red-catestado">Cat&aacute;logo Estado</div>
	...
	<table>
		<tr>
            ...
            <td nowrap="nowrap">
                 ...
                 <?php /*?> <?php include("../scripts/clases/class.sitd_cat_estado.php");$catestado = new catestado(); ?>                 
				 <?php $catestado->listar_catalogo('eventonacional',$_SESSION["id"]);?>
                ...
                <?php $catrama->listar_catalogo('marca',$_SESSION["idempresa"]);?>                      
				 ...
				 <?php include("../scripts/clases/class.sitd_cat_estado.php");$catestado = new catestado(); ?>                                         
    ...
    <div id="tabla_desplegado">
	           <?php			                    
				$catestado->limite=10;
				$catestado->filtro='';
				$catestado->campo='id_estado';
				$catestado->orden='desc';
				$catestado->pagina=1;
				$catestado->paginado=0;
				$catestado->idusuario=$_SESSION["id"];
				$catestado->mostrarCatEstado();
              ?>
    </div> 
