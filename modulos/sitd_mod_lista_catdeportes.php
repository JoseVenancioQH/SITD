...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_lista_catdeportes.js"></script>
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('addall','Editar Grupo Deportes')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('edit','Editar Deportes')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('add','Nueva Deportes');" class="toolbar">
                        ...
                        <div class="header icon-48-red-catdeportes">Cat&aacute;logo Deportes</div>
	...
	<table>
		<tr>
            ...
            <td nowrap="nowrap">
                 ...
                 <?php include("../scripts/clases/class.sitd_cat_deportes.php");$catdeportes = new catdeportes(); ?>                 
    ...
    <div id="tabla_desplegado">
	           <?php			                    
				$catdeportes->limite=10;
				$catdeportes->filtro='';
				$catdeportes->campo='id_deportes';
				$catdeportes->orden='desc';
				$catdeportes->pagina=1;
				$catdeportes->paginado=0;
				$catdeportes->idusuario=$_SESSION["id"];
				$catdeportes->mostrarCatDeportes();
              ?>
    </div> 
