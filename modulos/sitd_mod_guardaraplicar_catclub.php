...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_general.js"></script>
   <script type="text/javascript" src="../js/sitd_js_guardaraplicar_catclub.js"></script>
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <td class="button" id="toolbar-cancel">
                              <a href="sitd_mod_lista_catclub.php" class="toolbar">
                        ...
                        <div class="header icon-48-red-catclub-<?php echo $_GET["tipo"]; ?>"><?php echo $_GET["texto"]; ?></div>
		...
		<legend>Datos del Club</legend>
			<table class="admintable" cellspacing="1">
                <tr>
					...
					<td>                       
						<input name="club" id="club" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>				
				<tr>
					<td class="key">
						<label for="asocdep">Nombre Asociación Dep.</label>
					</td>
					<td>
