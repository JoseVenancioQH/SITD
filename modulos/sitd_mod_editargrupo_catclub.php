...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_general.js"></script>
   <script type="text/javascript" src="../js/sitd_js_guardaraplicar_catrama.js"></script>
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <td class="button" id="toolbar-cancel">
                              <a href="sitd_mod_lista_catrama.php" class="toolbar">
    ...
    <form id="form_catrama">
    <div id="tabla_desplegado">	
	<div class="col width-100">       
		<fieldset class="adminform">
		<legend>Datos de Rama</legend>
			<table class="admintable" cellspacing="1">
                <tr>
					<td width="150" class="key">
						<label for="ramas">Grupo Rama</label>
					</td>
					<td>                       
						<?php include("../scripts/clases/class.sitd_cat_rama.php");$catrama = new catrama();?>                 
				        <?php $catrama->listar_ramas('rama',$_GET["ids"],$_SESSION["id"]);?>
					</td>
				</tr>				
				<tr>
					<td class="key">
					...
					<td>                                          
				         <?php $catrama->listar_catalogo('eventonacional',$_SESSION["id"]);?>						
					</td>
				</tr>												
			</table>
		</fieldset>
