...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_lista_regentdep.js"></script>
  <script type="text/javascript" src="../js/sitd_js_curp.js"></script> 
  <script type="text/javascript" src="../js/jquery.validationEngine-es.js"></script>
  <script type="text/javascript" src="../js/jquery.validationEngine.js"></script>
  <script type="text/javascript" src="../js/jquery.numeric.js"></script>
  <script type="text/javascript" src="../js/jquery.blockUI.js"></script> 
  <script type="text/javascript" src="../js/jquery.maskedinput-1.2.2.js"></script>
  <script type="text/javascript" src="../js/jquery.date.2012.js"></script>  
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('addall','Editar Grupo Prueba')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('edit','Editar Prueba')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('add','Nueva Prueba');" class="toolbar">
                        ...
                        <div class="header icon-48-red-catcat">Registro Ente Deportivo</div>
	...
	<table>
		<tr>
            ...
            <td>Desde:</td><td><input type="text" id="fechadesde" class="icon-fecha fecha" value="" size="17"/></td>
            <td>Hasta:</td><td><input type="text" id="fechahasta" class="icon-fecha fecha" value="" size="17"/></td>
            <td nowrap="nowrap">                 
                 <?php include("../scripts/clases/class.sitd_regentdep.php");$regentdep = new regentdep(); ?>     
                 <?php $regentdep->listar_catalogo('estado',$_SESSION["id"]);?>                                      
                 <select name='filter_genero' id='filter_genero' class='inputbox'>
    ...
    <form id="form_regentdep">
    <div id="tabla_desplegado">
	           <?php			                    
				$regentdep->limite=10;
				$regentdep->filtro='';
				$regentdep->campo='entd.id_regentdep';
				$regentdep->orden='desc';
				$regentdep->pagina=1;
				$regentdep->paginado=0;
				$regentdep->idusuario=$_SESSION["id"];
				$regentdep->mostrarRegEnteDep();
              ?>
    </div> 
    </form> 
    ...
    <input type="hidden" id="acciones" value="<?php echo $_SESSION["acciones"]; ?>"/>
	 <div class="clr"></div>
	  </div>
	     <div class="b">
				<div class="b">
