...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_lista_catevenac.js"></script>
...
<body id="minwidth-body">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                             ...
                             <!-- <td class="button" id="toolbar-editargrupo">
                              ...
                              <a href="#" onclick="javascript:operacion('edit','Editar Evento Nacional')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('add','Nueva Evento Nacional');" class="toolbar">
                        ...
                        <div class="header icon-48-red-cateventonacional">Cat&aacute;logo Evento Nacional</div>
    ...
    <div id="tabla_desplegado">
	           <?php			                    
				$catevenac->limite=10;
				$catevenac->filtro='';
				$catevenac->campo='id_eventonacional';
				$catevenac->orden='desc';
				$catevenac->pagina=1;
				$catevenac->paginado=0;
				$catevenac->idusuario=$_SESSION["id"];
				$catevenac->mostrarCatEveNac();
              ?>
    </div> 
