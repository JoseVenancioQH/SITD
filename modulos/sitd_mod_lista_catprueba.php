...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_lista_catprueba.js"></script>
...
<body id="minwidth-body">
			...
			<div class="padding">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        ...
                        <div class="header icon-48-red-catcat">Cat&aacute;logo Pruebas</div>
	...
	<table>
		<tr>
            ...
            <td nowrap="nowrap">
                 ...
                 <?php include("../scripts/clases/class.sitd_cat_prueba.php");$catprueba = new catprueba(); ?>     
                 <?php $catprueba->listar_catalogo('eventonacional',$_SESSION["id"]);?>                                      
    ...
    <div id="tabla_desplegado">
	           <?php			                    
				$catprueba->limite=10;
				$catprueba->filtro='';
				$catprueba->campo='ca.id_categoria';
				$catprueba->orden='desc';
				$catprueba->pagina=1;
				$catprueba->paginado=0;
				$catprueba->idusuario=$_SESSION["id"];
				$catprueba->mostrarCatPrueba();
              ?>
    </div> 
