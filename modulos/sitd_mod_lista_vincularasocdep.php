...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_lista_catasocdep.js"></script>
...
<body id="minwidth-body">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                             ...
                             <!-- <td class="button" id="toolbar-editargrupo">
                              <a href="#" onclick="javascript:operacion('addall','Editar Grupo Asociaci&oacute;n Deportiva')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('edit','Editar Asociaci&oacute;n Deportiva')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('add','Nueva Asociaci&oacute;n Deportiva');" class="toolbar">
                        ...
                        <div class="header icon-48-red-catasocdep">Cat&aacute;logo Asociaci&oacute;n Deportiva</div>
    ...
    <div id="tabla_desplegado">
	           <?php			                    
				$catasocdep->limite=10;
				$catasocdep->filtro='';
				$catasocdep->campo='id_asocdep';
				$catasocdep->orden='desc';
				$catasocdep->pagina=1;
				$catasocdep->paginado=0;
				$catasocdep->idusuario=$_SESSION["id"];
				$catasocdep->mostrarCatAsocDep();
              ?>
    </div> 
