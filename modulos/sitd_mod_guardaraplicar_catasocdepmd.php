...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_guardaraplicar_catasocdepmd.js"></script>
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <td class="button" id="toolbar-cancel">
                              <a href="sitd_mod_lista_catasocdepmd.php" class="toolbar">
                        ...
                        <div class="header icon-48-red-catasocdepmd-<?php echo $_GET["tipo"]; ?>"><?php echo $_GET["texto"]; ?></div>
    ...
    <form id="form_catasocdepmd">
    <div id="tabla_desplegado">	
	<div class="col width-100">       
		<fieldset class="adminform">
		<legend>Datos de Asoc. Dep. Mesa Dir.</legend>
			<table class="admintable" cellspacing="1">               				
				<tr>
					<td class="key">
						<label for="asocdep">Asociación Deportiva</label>
					</td>
					<td>
                         <?php include("../scripts/clases/class.sitd_cat_asocdepmd.php");$catasocdepmd = new catasocdepmd(); ?>             
				         <?php $catasocdepmd->listar_catalogo('asocdep',$_SESSION["id"]);?>						
					</td>
				</tr>
                <tr>
					...
					<td>                       
						<input name="nombre" id="nombre" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>												
                <tr>
					<td width="150" class="key">
					...
					<td>                       
						<input name="app" id="app" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>												
                <tr>
					<td width="150" class="key">
					...
					<td>                       
						<input name="apm" id="apm" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>												
                <tr>
					<td width="150" class="key">
					...
					<td>                       
						<input name="cargo" id="cargo" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>												
                <tr>
					<td width="150" class="key">
					...
					<td>                       
						<input name="telefono" id="telefono" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>
                <tr>
					<td width="150" class="key">
					...
					<td>                       
						<input name="dom" id="dom" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>
                <tr>
					<td width="150" class="key">
					...
					<td>                       
						<input name="rfc" id="rfc" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>												
			</table>
		</fieldset>
