...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_general.js"></script>
   <script type="text/javascript" src="../js/sitd_js_guardaraplicar_catliga.js"></script>
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <td class="button" id="toolbar-cancel">
                              <a href="sitd_mod_lista_catliga.php" class="toolbar">
                        ...
                        <div class="header icon-48-red-catliga-<?php echo $_GET["tipo"]; ?>"><?php echo $_GET["texto"]; ?></div>
    ...
    <form id="form_catliga">
    <div id="tabla_desplegado">	
	<div class="col width-100">       
		<fieldset class="adminform">
		<legend>Datos de Liga</legend>
			<table class="admintable" cellspacing="1">
                <tr>
					...
					<td>                       
						<input name="liga" id="liga" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>				
				<tr>
					<td class="key">
						<label for="club">Nombre Club</label>
					</td>
					<td>
                         <?php include("../scripts/clases/class.sitd_cat_liga.php");$catliga = new catliga(); ?>            
				         <?php $catliga->listar_catalogo('club',$_SESSION["id"]);?>						
					</td>
				</tr>												
			</table>
		</fieldset>
    ...
    <script type="text/javascript">edit_data();jQuery("#filter_club").addClass("validate[required]");</script>
