...
<head>
  ...
  <script type="text/javascript" src="../js/caut_js_lista_invcosto.js"></script>
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('edit','Editar Auto')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('add','Nueva Auto');" class="toolbar">
                        ...
                        <div class="header icon-48-costo">Inventario Costo Autos</div>
	...
	<table>
		<tr>
            ...
            <td nowrap="nowrap">
                 ...
                 <?php include("../scripts/clases/class.red_invcosto.php");$invcosto = new invcosto(); ?>				 
                 
				 <?php $invcosto->listar_catalogo('modelo',$_SESSION["idempresa"]);?>
                 
                 <?php $invcosto->listar_catalogo('marca',$_SESSION["idempresa"]);?>                      
                 
                 <?php $invcosto->listar_catalogo('linea',$_SESSION["idempresa"]);?>
                 
                 <?php $invcosto->listar_catalogo('color',$_SESSION["idempresa"]);?>
                 
                 <?php $invcosto->listar_catalogo('tipo',$_SESSION["idempresa"]);?>                                            
    ...
    <div id="tabla_desplegado">
	           <?php			                    
				$invcosto->limite=10;
				$invcosto->filtro='';
				$invcosto->campo='id_costoventa';
				$invcosto->orden='desc';
				$invcosto->pagina=1;
				$invcosto->paginado=0;
				$invcosto->idempresa=$_SESSION["idempresa"];
				$invcosto->mostrarInvAutoCosto();
              ?>
    </div> 
