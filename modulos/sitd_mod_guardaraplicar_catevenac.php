...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_general.js"></script>
   <script type="text/javascript" src="../js/sitd_js_guardaraplicar_catevenac.js"></script>
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <td class="button" id="toolbar-cancel">
                              <a href="sitd_mod_lista_catevenac.php" class="toolbar">
                        ...
                        <div class="header icon-48-red-cateventonacional-<?php echo $_GET["tipo"]; ?>"><?php echo $_GET["texto"]; ?></div>
    ...
    <form id="form_catevenac">
    <div id="tabla_desplegado">	
	<div class="col width-100">       
		<fieldset class="adminform">
		<legend>Datos de Evento Nacional</legend>
			<table class="admintable" cellspacing="1">
                <tr>
					<td width="150" class="key">
						<label for="evenac">Nombre Evento Nacional</label>
					</td>
					<td>                       
						<input name="evenac" id="evenac" class="validate[required] inputbox" size="40" type="text" value="" />
					</td>
				</tr>				
                <tr>
					<td class="key">
						<label for="eventonacional">Fecha Evento Nacional</label>
					</td>
                    <td>
                      <table cellspacing="1">
                      <tr>
