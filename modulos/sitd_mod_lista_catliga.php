...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_lista_catliga.js"></script>
...
<body id="minwidth-body">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                             ...
                             <!-- <td class="button" id="toolbar-editargrupo">
                              <a href="#" onclick="javascript:operacion('addall','Editar Grupo Liga')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('edit','Editar Liga')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('add','Nueva liga');" class="toolbar">
                        ...
                        <div class="header icon-48-red-catliga">Cat&aacute;logo Liga</div>
    ...
    <div id="tabla_desplegado">
	           <?php			                    
				$catliga->limite=10;
				$catliga->filtro='';
				$catliga->campo='id_liga';
				$catliga->orden='desc';
				$catliga->pagina=1;
				$catliga->paginado=0;
				$catliga->idusuario=$_SESSION["id"];
				$catliga->mostrarCatLiga();
              ?>
    </div> 
