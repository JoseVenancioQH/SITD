...
<script type="text/javascript" src="../js/controller-modalidad.js"></script>
...
<div class="container">		
    ...
    <div id="form">
			 ...
			 <form name="grabar-modalidad" id="grabar-modalidad" method="post" action="">             	
             <fieldset><legend>Datos de la Modalidad</legend>		 
			
			    <div class="span-7">
				<p>
				<label for="nombre-text">Nombre de la Modalidad: </label>
				<input  alt="Nombre de la Modalidad" class="validate[required,length[0,150]] span-7 text" id="nombre-text" name="nombre-text" type="text"/>				
				</p>
				</div>
									
			 </fieldset>		 
			 <input id = "grabar_modalidad_buttom" name = "grabar_modalidad_buttom" type="submit" value="Grabar Modalidad"/>			 
             </form>			 					   
        </div>
        <fieldset><legend>Lista de Modalidades Registradas</legend>		 
		     <table>
             <thead>        	   
             ...
             <tbody id = "lista_modalidad" class="scroll1"> 	
             </tbody>			 
             </table>	
