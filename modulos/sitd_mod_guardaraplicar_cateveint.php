...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_general.js"></script>
   <script type="text/javascript" src="../js/sitd_js_guardaraplicar_cateveint.js"></script>
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <td class="button" id="toolbar-cancel">
                              <a href="sitd_mod_lista_cateveint.php" class="toolbar">
                        ...
                        <div class="header icon-48-red-cateveint-<?php echo $_GET["tipo"]; ?>"><?php echo $_GET["texto"]; ?></div>
    ...
    <form id="form_cateveint">
    <div id="tabla_desplegado">	
	<div class="col width-100">       
		<fieldset class="adminform">
		<legend>Datos de Evento Internacional</legend>
			<table class="admintable" cellspacing="1">
                <tr>
					<td width="150" class="key">
						<label for="evenac">Nombre Evento Internacional</label>
					</td>
					<td>                       
						<input name="eveint" id="eveint" class="validate[required] inputbox" size="40" type="text" value="" />
					</td>
				</tr>				
                <tr>
					<td class="key">
						<label for="eventoint">Fecha Evento Internacional</label>
					</td>
                    <td>
                      <table cellspacing="1">
                      <tr>
                        ...
                        <td>
                             <input name="fechainicio" id="fechainicio" class="validate[required] inputbox" size="20" type="text" value="" />
                        </td>
                        <td>
                            <label>Hasta:</label>
                        </td>
                        <td>
                             <input name="fechatermina" id="fechatermina" class="validate[required] inputbox" size="20" type="text" value="" />
                        </td>                    
                     </tr>   
                     </table>
                    </td>
				...
				<!--<tr>
					<td class="key">
						<label for="eventonacionalinicio">Fecha Inicio Evento Nacional</label>
					</td>
					<td>
                         <input name="fechainicio" id="fechainicio" class="validate[required] inputbox" size="30" type="text" value="" />
					</td>                    
				</tr>	
                <tr>
                    <td class="key">
						<label for="eventonacionaltermina">Fecha Terminación Evento Nacional</label>
					</td>
					<td>
                         <input name="fechatermina" id="fechatermina" class="validate[required] inputbox" size="30" type="text" value="" />
					</td>
                </tr>-->											
			</table>
		</fieldset>
