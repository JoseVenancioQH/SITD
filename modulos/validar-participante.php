...
<script type="text/javascript" src="../js/controller-participantevalidado.js"></script>
...
<div class="container">    
       ...
       <ul id="menu">
        ...
        ?>       
            ...
            <ul id="submenu">
                <?php
			        $seccion = "valparticipantes";
			        include("../scripts/menu-valparticipantes.php");
                ?>
            </ul>            
    </div>
    ...
    <div id="dialog_validar_participante" title="Documentos Participante">   
    <table class="nospace">
    <tr><td colspan="2" style="background:#369; color:#FFF;"><input type="checkbox"  id="todas_documento"/>Todas</td><td></td></tr>
    <tr>
    <td><input type="checkbox"  id="curp_documento"/>CURP</td>
    <td><input type="checkbox"  id="acta_documento"/>Acta Nacimiento</td>
    </tr>
    <tr>
    <td><input type="checkbox"  id="constancia_documento"/>Constancia Medica</td>
    <td><input type="checkbox"  id="sired_documento"/>Sired</td>
    </tr>
    <tr>
    <td><input type="checkbox"  id="fotos_documento"/>Fotos</td>
    <td><input type="checkbox"  id="identificacion_documento"/>Identificaci&oacute;n</td>
    </tr>
    </table>  
    </div>
    
     <div id="form">
            <h2>Validar Participantes</h2>	
            ...
            <li id="imprimir_validar_div" style="font-size:9px;">
            <!--<div id="grabar_participante_div" style="float:right; font-size:8px; margin-left:5px;">-->
            <a onclick="javascript:ImprimirValidar();" style="cursor:pointer; text-decoration:none;">
            <table class="nospace"><tr><td style="text-align:center;">
            <img id="imprimirvalidar" style="vertical-align:middle; cursor:pointer;" alt="Imprimir Validar" src="../img/imprimir_cedula.png"/>
            </td></tr>
            <tr><td style="text-align:center;">
            <span style="vertical-align:middle; text-align:center;">Imprimir<br />Lista</span>
            </td></tr></table>
            </a>
            <!--</div>-->
            </li>    
            ...
            <li id="elminar_validar_participante_div" style="font-size:9px;">
            <!--<div id="grabar_participante_div" style="float:right; font-size:8px; margin-left:5px;">-->
            <a onclick="javascript:ValidarParticipante('no');" style="cursor:pointer; text-decoration:none;">
            <table class="nospace"><tr><td style="text-align:center;">
            <img id="eliminarvalidarparticipante" style="vertical-align:middle; cursor:pointer;" alt="Eliminar Validar Participante" src="../img/cancelar_validar_participante.png"/>
            </td></tr>
            <tr><td style="text-align:center;">
            <span style="vertical-align:middle; text-align:center;">Eliminar<br />Validar Participante</span>
            </td></tr></table>
            </a>
            <!--</div>-->
            </li>    
            ...
            <li id="validar_participante_div" style="font-size:9px;">
            <!--<div id="grabar_participante_div" style="float:right; font-size:8px; margin-left:5px;">-->
            <a onclick="javascript:ValidarParticipante('si');" style="cursor:pointer; text-decoration:none;">
            <table class="nospace"><tr><td style="text-align:center;">
            <img id="validarparticipante" style="vertical-align:middle; cursor:pointer;" alt="Validar Participante" src="../img/validar_participante.png"/>
            </td></tr>
            <tr><td style="text-align:center;">
            <span style="vertical-align:middle; text-align:center;">Validar<br />Participante</span>
            </td></tr></table>
            </a>
            <!--</div>-->
            </li>    
            ...
            <div class="clear"></div>     
            <div id="listvalidar_div">
            <table id="listvalidar"></table> 
            <div id="listvalidarpager"></div>              
            </div>
