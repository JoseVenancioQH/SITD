...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_general.js"></script>
   <script type="text/javascript" src="../js/sitd_js_guardaraplicar_catasocdep.js"></script>
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <td class="button" id="toolbar-cancel">
                              <a href="sitd_mod_lista_catasocdep.php" class="toolbar">
                        ...
                        <div class="header icon-48-red-catasocdep-<?php echo $_GET["tipo"]; ?>"><?php echo $_GET["texto"]; ?></div>
    ...
    <form id="form_catasocdep">
    <div id="tabla_desplegado">	
	<div class="col width-100">       
		<fieldset class="adminform">
		<legend>Datos de Asociaci&oacute;n Deportiva</legend>
			<table class="admintable" cellspacing="1">
                <tr>
					<td width="150" class="key">
						<label for="asocdep">Nombre Asociaci&oacute;n Deportiva</label>
					</td>
					<td>                       
						<input name="asocdep" id="asocdep" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>				
				<tr>
					<td class="key">
					...
					<td>
                         <?php include("../scripts/clases/class.sitd_cat_asocdep.php");$catasocdep = new catasocdep(); ?>                 
				         <?php $catasocdep->listar_catalogo('deportes',$_SESSION["id"]);?>						
					</td>
				</tr>
                <tr>
					<td class="key">
						<label for="Deporte">Municipio</label>
					</td>
					<td>                    
				         <?php $catasocdep->listar_catalogo('municipio',$_SESSION["id"]);?>						
					</td>
				</tr>												
                <tr>
					<td width="150" class="key">
						<label for="dircalle">Direcci&oacute;n Calle</label>
					</td>
					<td>                       
						<input name="dircalle" id="dircalle" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>
                <tr>
					<td width="150" class="key">
						<label for="dirnum">Direcci&oacute;n N&uacute;mero</label>
					</td>
					<td>                       
						<input name="dirnum" id="dirnum" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>
                <tr>
					<td width="150" class="key">
						<label for="dircolonia">Direcci&oacute;n Colonia</label>
					</td>
					<td>                       
						<input name="dircolonia" id="dircolonia" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>
                <tr>
					<td width="150" class="key">
						<label for="telconv">Tel&eacute;fono Convencional</label>
					</td>
					<td>                       
						<input name="telconv" id="telconv" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>
                <tr>
					<td width="150" class="key">
					...
					<td>                       
						<input name="telcel" id="telcel" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>
                <tr>
					<td width="150" class="key">
						<label for="dircorreo">Dirección de Correo</label>
					</td>
					<td>                       
						<input name="dircorreo" id="dircorreo" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>
                <tr>
					<td width="150" class="key">
					...
					<td>                       
						<input name="acronimo" id="acronimo" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>                
			</table>
		</fieldset>
