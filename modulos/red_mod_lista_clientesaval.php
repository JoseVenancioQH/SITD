...
<head>
  ...
  <script type="text/javascript" src="../js/caut_js_lista_clientesaval.js"></script>
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <a href="#" onclick="javascript:borraraval()" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('edit','Editar Aval Cliente')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('add','Nuevo Aval Cliente');" class="toolbar">
                        ...
                        <div class="header icon-48-clienteaval">Registro de Aval Cliente</div>
    ...
    <div id="tabla_desplegado">
	           <?php			    
                include("../scripts/clases/class.red_clientesaval.php");
				$clientesaval = new clientesaval();
				$clientesaval->limite=10;
				$clientesaval->filtro='';
				$clientesaval->campo='id_avalcliente';
				$clientesaval->orden='desc';
				$clientesaval->pagina=1;
				$clientesaval->paginado=0;
				$clientesaval->mostrarClientesAval();
              ?>
    </div>    
	   <div class="clr"></div>
	  </div>
