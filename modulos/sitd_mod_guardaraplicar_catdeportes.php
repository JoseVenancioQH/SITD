...
<body id="minwidth-body">
			...
			<div class="padding">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        ...
                        <div class="header icon-48-red-catdeportes-<?php echo $_GET["tipo"]; ?>"><?php echo $_GET["texto"]; ?></div>
	...
	<div class="col width-100">       
		...
		<legend>Datos de Deporte</legend>
			<table class="admintable" cellspacing="1">
                <tr>
					<td width="150" class="key">
						<label for="rama">Nombre Deporte</label>
					</td>
					<td>                       
						<input name="deportes" id="deportes" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>				
				<tr>
					<td class="key">
