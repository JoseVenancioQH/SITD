...
<head>
  ...
  <script type="text/javascript" src="../js/caut_js_guardaraplicar_ventaauto.js"></script>
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <td class="button" id="toolbar-cancel">
                              <a href="red_mod_lista_ventaauto.php" class="toolbar">
		...
		<legend>Datos del Cliente</legend>
			<table class="admintable" cellspacing="1">
                <tr>
					...
					<td>                       
						<input name="nomcliente" id="nomcliente" class="validate[required] inputbox autocomplete_nombre mayuscula" size="80" type="text" value="" />
					</td>
				</tr>
                <tr>
					<td width="150" class="key">
					...
					<td>                       
						<input name="appaternocliente" id="appaternocliente" class="validate[required] inputbox autocomplete_nombre mayuscula" size="80" type="text" value="" />
					</td>
				</tr>
				<tr>
					<td width="150" class="key">
					...
					<td>
						<input type="text" name="apmaternocliente" id="apmaternocliente" class="validate[required] inputbox autocomplete_nombre mayuscula" size="80" value="" />
					</td>
				</tr>
                <tr>
					<td width="150" class="key">
					...
					<td>            
                        <input type="text"  id="municipio" class="validate[required] autocomplete"/>           
                ...
                <tr>
					<td width="150" class="key">
						<label for="dircliente">Direcci&oacute;n</label>
					</td>
					<td>
						<input type="text" name="dircliente" id="dircliente" class="validate[required] inputbox" size="80" value="" />
					</td>
				</tr>
                <tr>
					<td width="150" class="key">
					...
					<td>
						<input type="text" name="telcel" id="telcel" class="validate[required] inputbox" size="80" value="" />
					</td>
				</tr>
                <tr>
					<td width="150" class="key">
					...
					<td>
						<input type="text" name="telcasa" id="telcasa" class="validate[required] inputbox" size="80" value="" />
					</td>
				</tr>
                <tr>
					<td width="150" class="key">
						<label for="rfccliente">R.F.C.</label>
					</td>
					<td>
						<input type="text" name="rfccliente" id="rfccliente" class="validate[required] inputbox" size="80" value="" />
					</td>
				</tr>																
			</table>            
		</fieldset>        
