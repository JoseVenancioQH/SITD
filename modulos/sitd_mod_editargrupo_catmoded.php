...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_general.js"></script>
   <script type="text/javascript" src="../js/sitd_js_guardaraplicar_catmoded.js"></script>
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <td class="button" id="toolbar-save" style="display:<?php if($_GET["tipo"]=='add' || $_GET["tipo"]=='addall') echo 'inline;'; else echo 'none;';?>">
                              <a href="#" onclick="javascript:validar('guardartodo');" class="toolbar">
                              ...
                              <td class="button" id="toolbar-cancel">
                              <a href="sitd_mod_lista_catmoded.php" class="toolbar">
                        ...
                        <div class="header icon-48-red-catmodentdep-<?php echo $_GET["tipo"]; ?>"><?php echo $_GET["texto"]; ?></div>
    ...
    <form id="form_catmoded">
    <div id="tabla_desplegado">	
	<div class="col width-100">       
		<fieldset class="adminform">
		<legend>Datos de Modalidad Ente Deportivo</legend>
			<table class="admintable" cellspacing="1">
                <tr>
					<td width="150" class="key">
						<label for="moded">Grupo Modalidad Ente Deportivo</label>
					</td>
					<td>                       
						<?php include("../scripts/clases/class.sitd_cat_moded.php");$catmoded = new catmoded();?>                 
				        <?php $catmoded->listar_moded('moded',$_GET["ids"],$_SESSION["id"]);?>
					</td>
				</tr>				
				<tr>
					<td class="key">
    ...
    <script type="text/javascript">/*editall_data();*/</script>
