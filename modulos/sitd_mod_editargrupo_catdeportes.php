...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_general.js"></script>
   <script type="text/javascript" src="../js/sitd_js_guardaraplicar_catdeportes.js"></script>
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <td class="button" id="toolbar-cancel">
                              <a href="sitd_mod_lista_catdeportes.php" class="toolbar">
                        ...
                        <div class="header icon-48-red-catrama-<?php echo $_GET["tipo"]; ?>"><?php echo $_GET["texto"]; ?></div>
    ...
    <form id="form_catdeportes">
    <div id="tabla_desplegado">	
	<div class="col width-100">       
		<fieldset class="adminform">
		<legend>Datos de Deportes</legend>
			<table class="admintable" cellspacing="1">
                <tr>
					<td width="150" class="key">
						<label for="deportes">Grupo Deportes</label>
					</td>
					<td>                       
						<?php include("../scripts/clases/class.sitd_cat_deportes.php");$catdeportes = new catdeportes();?>                        <?php $catdeportes->listar_deportes('deportes',$_GET["ids"],$_SESSION["id"]);?>
					</td>
				</tr>				
				<tr>
					<td class="key">
					...
					<td>                                          
				         <?php $catdeportes->listar_catalogo('eventonacional',$_SESSION["id"]);?>						
					</td>
				</tr>												
			</table>
		</fieldset>
