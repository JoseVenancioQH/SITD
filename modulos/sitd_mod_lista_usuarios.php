...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_lista_usuarios.js"></script>
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('edit','Editar Usuario')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('add','Nuevo Usuario');" class="toolbar">
                        ...
                        <div class="header icon-48-user">Gestor de usuarios</div>
