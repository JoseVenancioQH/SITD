...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_lista_catmoddep.js"></script>
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('addall','Editar Grupo Modalidad Deportiva')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('edit','Editar Modalidad Deportiva')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('add','Nueva Modaldiad Deportiva');" class="toolbar">
                        ...
                        <div class="header icon-48-red-catmodalidaddep">Cat&aacute;logo Modalidad Deportiva</div>
    ...
    <div id="tabla_desplegado">
	           <?php			                    
				$catmoddep->limite=10;
				$catmoddep->filtro='';
				$catmoddep->campo='id_moddep';
				$catmoddep->orden='desc';
				$catmoddep->pagina=1;
				$catmoddep->paginado=0;
				$catmoddep->idusuario=$_SESSION["id"];
				$catmoddep->mostrarCatModDep();
              ?>
    </div> 
