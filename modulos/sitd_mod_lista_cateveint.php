...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_lista_cateveint.js"></script>
...
<body id="minwidth-body">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                             ...
                             <!-- <td class="button" id="toolbar-editargrupo">
                              ...
                              <a href="#" onclick="javascript:operacion('edit','Editar Evento Internacional')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('add','Nueva Evento Internacional');" class="toolbar">
                        ...
                        <div class="header icon-48-red-cateveint">Cat&aacute;logo Evento Internacional</div>
	...
	<table>
		<tr>
            ...
            <td nowrap="nowrap">
            <?php include("../scripts/clases/class.sitd_cat_eveint.php");$cateveint = new cateveint(); ?> 
            <?php /*?>
                 <?php include("../scripts/clases/class.sitd_cat_evenac.php");$catevenac = new catevenac(); ?>                 
				 <?php $catevenac->listar_catalogo('eventonacional',$_SESSION["id"]);?>
    ...
    <div id="tabla_desplegado">
	           <?php			                    
				$cateveint->limite=10;
				$cateveint->filtro='';
				$cateveint->campo='id_eventointer';
				$cateveint->orden='desc';
				$cateveint->pagina=1;
				$cateveint->paginado=0;
				$cateveint->idusuario=$_SESSION["id"];
				$cateveint->mostrarCatEveInt();
              ?>
    </div> 
