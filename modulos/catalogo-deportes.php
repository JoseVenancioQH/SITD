...
<script type="text/javascript" src="../js/controller-deportes.js"></script>
...
<div class="container">		
    ...
    <div id="form">
			 ...
			 <form name="grabar-deportes" id="grabar-deportes" method="post" action="">             	
             <fieldset><legend>Datos del Deporte</legend>		 
			
			    <div class="span-7">
				<p>
				<label for="nombre-text">Nombre del Deporte: </label>
				<input  alt="Nombre del Deporte" class="validate[required,length[0,150]] span-7 text" id="nombre-text" name="nombre-text" type="text"/>				
				</p>
				</div>
									
			 </fieldset>		 
			 <input id="grabar_deportes_buttom" type="submit" value="Grabar Deporte"/>			 
             </form>			 					   
        </div>
    <fieldset><legend>Lista de Deportes Registradas</legend>
	<div class="scroll">		 
		     <table>
             <thead>        	   
