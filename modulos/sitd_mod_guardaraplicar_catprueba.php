...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_general.js"></script>
   <script type="text/javascript" src="../js/sitd_js_guardaraplicar_catprueba.js"></script>
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <td class="button" id="toolbar-cancel">
                              <a href="sitd_mod_lista_catprueba.php" class="toolbar">
			...
			<table class="admintable" cellspacing="1">
                <tr>
					<td width="150" class="key">
						<label for="rama">Nombre Prueba</label>
					</td>
					<td>                       
						<input name="prueba" id="prueba" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>
                <!--<tr>
					<td width="150" class="key">
                ...
                <tr>
					<td class="key">
						<label for="catprueba">Categoria</label>
					</td>
					<td>
				        <select name='filter_catprueba' id='filter_catprueba' class='validate[required] inputbox' disabled='disabled'>
                        <option value='' selected>- Selecciona Categorias -</option>
                        </select> 						
					</td>
				</tr>											
			</table>
