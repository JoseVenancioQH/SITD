...
<head>
  ...
  <script type="text/javascript" src="../js/caut_js_lista_ventaauto.js"></script>
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('edit','Editar Venta Auto')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('add','Nueva Venta Auto');" class="toolbar">
                        ...
                        <div class="header icon-48-ventaauto">Venta de Autos</div>
	...
	<table>
		<tr>
            ...
            <td nowrap="nowrap">
                 ...
                 <?php include("../scripts/clases/class.red_ventaauto.php");$ventaauto = new ventaauto(); ?>				 
                 
				 <?php $ventaauto->listar_catalogo('modelo',$_SESSION["idempresa"]);?>
                 
                 <?php $ventaauto->listar_catalogo('marca',$_SESSION["idempresa"]);?>                      
                 
                 <?php $ventaauto->listar_catalogo('linea',$_SESSION["idempresa"]);?>
                 
                 <?php $ventaauto->listar_catalogo('color',$_SESSION["idempresa"]);?>
                 
                 <?php $ventaauto->listar_catalogo('tipo',$_SESSION["idempresa"]);?>                                            
    ...
    <div id="tabla_desplegado">
	           <?php			                    
				$ventaauto->limite=10;
				$ventaauto->filtro='';
				$ventaauto->campo='id_ventaauto';
				$ventaauto->orden='desc';
				$ventaauto->pagina=1;
				$ventaauto->paginado=0;
				$ventaauto->idempresa=$_SESSION["idempresa"];
				$ventaauto->mostrarVentaAuto();
              ?>
    </div> 
