...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_lista_catmunicipio.js"></script>
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('edit','Editar Rama')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('add','Nueva Rama');" class="toolbar">
                        ...
                        <div class="header icon-48-red-catmunicipio">Cat&aacute;logo Municipio</div>
	...
	<table>
		<tr>
            ...
            <td nowrap="nowrap">
                 <?php include("../scripts/clases/class.sitd_cat_municipio.php");$catmunicipio = new catmunicipio(); ?> 
                 <?php $catmunicipio->listar_catalogo('estado',$_SESSION["id"]);?>
                 
                 <?php /*?> 
				 <?php include("../scripts/clases/class.sitd_cat_municipio.php");$catmunicipio = new catmunicipio(); ?>                 <?php $catmunicipio->listar_catalogo('eventonacional',$_SESSION["id"]);?>                 
                 <?php $catrama->listar_catalogo('marca',$_SESSION["idempresa"]);?>                                       
    ...
    <div id="tabla_desplegado">
	           <?php			                    
				$catmunicipio->limite=10;
				$catmunicipio->filtro='';
				$catmunicipio->campo='id_municipio';
				$catmunicipio->orden='desc';
				$catmunicipio->pagina=1;
				$catmunicipio->paginado=0;
				$catmunicipio->idusuario=$_SESSION["id"];
				$catmunicipio->mostrarCatMunicipio();
              ?>
    </div> 
