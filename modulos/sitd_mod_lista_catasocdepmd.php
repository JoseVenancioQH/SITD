...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_lista_catasocdepmd.js"></script>
...
<body id="minwidth-body">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                             ...
                             <!-- <td class="button" id="toolbar-editargrupo">
                              ...
                              <a href="#" onclick="javascript:operacion('edit','Editar Asoc. Dep. Mesa Dir')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('add','Nueva Asoc. Dep. Mesa Dir');" class="toolbar">
                        ...
                        <div class="header icon-48-red-catasocdepmd">Cat&aacute;logo Asoc. Dep. Mesa Dir.</div>
    ...
    <div id="tabla_desplegado">
	           <?php			                    
				$catasocdepmd->limite=10;
				$catasocdepmd->filtro='';
				$catasocdepmd->campo='id_mesadir';
				$catasocdepmd->orden='desc';
				$catasocdepmd->pagina=1;
				$catasocdepmd->paginado=0;
				$catasocdepmd->idusuario=$_SESSION["id"];
				$catasocdepmd->mostrarCatAsocDepMD();
              ?>
    </div> 
