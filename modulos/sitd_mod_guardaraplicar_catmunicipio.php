...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_general.js"></script>
   <script type="text/javascript" src="../js/sitd_js_guardaraplicar_catmunicipio.js"></script>
...
<body id="minwidth-body">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        <div class="toolbar" id="toolbar">
                              ...
                              <td class="button" id="toolbar-cancel">
                              <a href="sitd_mod_lista_catmunicipio.php" class="toolbar">
                        ...
                        <div class="header icon-48-red-catmunicipio-<?php echo $_GET["tipo"]; ?>"><?php echo $_GET["texto"]; ?></div>
    ...
    <form id="form_catmunicipio">
    <div id="tabla_desplegado">	
	<div class="col width-100">       
		<fieldset class="adminform">
		<legend>Datos Municipio</legend>
			<table class="admintable" cellspacing="1">
                <tr>
					...
					<td>                       
						<input name="municipio" id="municipio" class="validate[required] inputbox" size="60" type="text" value="" />
					</td>
				</tr>				
				<tr>
					<td class="key">
