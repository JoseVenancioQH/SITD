...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_lista_catmoded.js"></script>
...
-->
                              ...
                              <a href="#" onclick="javascript:operacion('addall','Editar Grupo Modalidad Ente Deportivo')" class="toolbar">
                              <span class="icon-32-editall" title="'Editar Grupo Modalidad Ente Deportivo">
                              </span>
                              Editar Nuevo Grupo
                              </a>
                              </td>
                              ...
                              <a href="#" onclick="javascript:operacion('edit','Editar Modalidad Ente Deportivo')" class="toolbar">
                              ...
                              <a href="#" onclick="javascript:operacion('add','Nuevo Modalidad Ente Deportivo');" class="toolbar">
                        ...
                        <div class="header icon-48-red-catmodentdep">Cat&aacute;logo Modalidad Ente Deportivo</div>
	...
	<table>
		<tr>
            ...
            <td nowrap="nowrap">            
                 <?php include("../scripts/clases/class.sitd_cat_moded.php");$catmoded = new catmoded(); ?>                 
				 <?php $catmoded->listar_catalogo('eventonacional',$_SESSION["id"]);?>
    ...
    <div id="tabla_desplegado">
	           <?php                
				...
				$catmoded->limite=10;
				$catmoded->filtro='';
				$catmoded->campo='id_moded';
				$catmoded->orden='desc';
				$catmoded->pagina=1;
				$catmoded->paginado=0;
				$catmoded->idusuario=$_SESSION["id"];
				$catmoded->mostrarCatModed();
              ?>
    </div>  
	...
	<p class="copyright">
		...
		<?php echo $_SESSION["nombre"]; ?> <a href="#">Sistema T&eacute;cnico Deportivo de BCS</a>.
    </p>
    </div>
    </div>
</body>
