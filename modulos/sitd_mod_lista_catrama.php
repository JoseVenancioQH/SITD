...
<head>
  ...
  <script type="text/javascript" src="../js/sitd_js_lista_catrama.js"></script>
...
<body id="minwidth-body">
			...
			<div class="padding">
				...
				<div id="toolbar-box">
                    ...
                    <div class="m">
                        ...
                        <div class="header icon-48-red-catrama">Cat&aacute;logo Rama</div>
    ...
    <div id="tabla_desplegado">
	           <?php			                    
				$catrama->limite=10;
				$catrama->filtro='';
				$catrama->campo='id_rama';
				$catrama->orden='desc';
				$catrama->pagina=1;
				$catrama->paginado=0;
				$catrama->idusuario=$_SESSION["id"];
				$catrama->mostrarCatRama();
              ?>
    </div> 
