...
class grabartodomas extends MySQL
{  	
    var $cargo = '';
	var $deporteextra = '';
	var	$evento = '';
...
function grabarParticipanteTodoMas()
	{	
...
////Registro Modalidad		
	   ...
	   if($num_total_registros==0)
		 ...
		 //print "INSERT INTO reg_modalidadparticipante (id_evento,id_registro,id_modalidad,reg_modalidadparticipante_deporte) VALUES (".$id_insert_evento.",".$id_insert_participante.",".$this->modalidad.",".$this->deporteextra.")";
		  $consulta = parent::consulta("INSERT INTO reg_modalidadparticipante (id_evento,id_registro,id_modalidad,reg_modalidadparticipante_deporte) VALUES (".$this->evento.",".$id_insert_participante.",".$this->modalidad.",".$this->deporteextra.")");		  
