...
{	
	...
	function GenerarCedulas()
	  ...
	  GROUP_CONCAT(DISTINCT cat_c.cat_categoria_nombre SEPARATOR '<br />') AS categoria,      
	  GROUP_CONCAT(DISTINCT reg_c.reg_categoriaparticipante_pruebas SEPARATOR ',') AS prueba
	  from
	  ((((((reg_participante as reg_p 
		...
		{					  
			   ...
			   {		
			    /*$actual['prueba'] = str_replace(',','<br />',$actual['prueba']);*/
